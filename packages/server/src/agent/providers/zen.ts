// OpenCode Zen provider — wraps the OpenAI SDK pointed at Zen's base URL.
//
// Zen is OpenCode's curated model gateway. Same OpenAI-compatible API,
// different base URL and auth key (OPENCODE_API_KEY).
