...
import type { ProjectLoadPermissionsParams, ProjectSavePermissionsParams } from '@vajra/protocol'
import { loadPermissions, defaultPermissions, savePermissions } from '../../native.js'
