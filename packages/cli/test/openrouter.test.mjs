...
const openrouterUrl = pathToFileURL(join(import.meta.dirname, '..', 'dist', 'agent', 'openrouter.js')).href
const { computeRetryDelayMs, streamChatCompletion } = await import(openrouterUrl)
